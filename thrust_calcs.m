function [thrust,specific_thrust,specfic_fuel_consumption,specfic_impulse] = thrust_calcs(P_in,P_out,T_in,T_out,M_in,M_out,m_dot,A_in,A_out,m_dot_fuel,slope,slope_b,distance,distance_b,inlet_drag)
